        ...
        <div>
          <Card padding={1}>
            <div className="flex items-center gap-2">
              <img
                className="object-cover border-2 border-white cursor-pointer rounded-4xl w-13 h-13"
              ...
              <div
                ...
                className="w-full px-4 py-3 cursor-pointer border-1 rounded-3xl hover:bg-gray-100"
              >
                Start a Post
              </div>
            </div>
