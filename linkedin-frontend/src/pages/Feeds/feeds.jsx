        ...
        <div>
          <Card padding={1}>
            ...
            <div className='my-1'>
              ...
              <div className='text-xs text-gray-400'>3hr ago</div>     
            </div>
          </Card>
        </div>
