...
const Profile = () => {
  ...
  return (
    <div className="px-5 xl:px-50 py-5 mt-5 flex flex-col gap-5 w-full pt-12 bg-gray-100">
            ...
            <Card padding={0}>
              <div className="w-full h-fit">
                <div className="relative w-full h-[200px]">
                  <div className="absolute text-[#0B63BD] bg-white rounded-full p-1.5 cursor-pointer top-3 right-3 z-20 flex justify-center items-center" onClick={handleOnEditCover}>
                    <EditOutlinedIcon />
                  </div>
                  <img
                  ...
                  />
                  <div onClick={handleCircularImageOpen} className="absolute object-cover top-24 left-6 z-10 md:top-24 md:left-6 sm:top-20 sm:left-3">
                    <img
                ...
                <div className="mt-14 relative px-8 py-2">
                  <div className="absolute cursor-pointer top-0 right-3 z-20 w-[40px] flex justify-center items-center h-[40px] rounded-full p-3 bg-white hover:bg-gray-100 text-gray-700 hover:text-gray-950" onClick={handleInfoModal}>
                    <EditOutlinedIcon />
                  </div>
                  ...
                  <div className="md:flex w-full justify-between">
                    ...
                    <div className="my-5 flex gap-5">
                      ...
                      <div className="cursor-pointer p-2 px-3 border rounded-4xl h-[95%] w-fit flex justify-center border-[#0B63BD] text-[#0B63BD] hover:border-2 hover:font-bold hover:bg-[#0B63BD]/9 font-semibold gap-1.5">
                        <MapsUgcIcon /> Message
                      </div>
                    </div>
                  </div>
          ...
          <div className="my-2">
            <Card padding={1}>
              <div className="flex justify-between items-center">
                ...
                <div className="cursor-pointer rounded-full p-2.5 bg-white hover:bg-gray-100 text-gray-700 hover:text-gray-950">
                  <EditOutlinedIcon />
                </div>
              </div>
          ...
          <div className="my-2">
            <Card padding={1}>
              <div className="flex justify-between items-center">
                ...
                <div className="flex justify-center items-center rounded-full p-3 bg-white hover:bg-gray-100 text-gray-700 hover:text-gray-990 cursor-pointer">
                  <AddIcon />
                </div>
              </div>
      ...
      {imageSetModal && (
        <Modal title="Upload Image" closeModal={handleImageModalOpenClose} profile={1}>
